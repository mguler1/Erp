  ...
  public  class CariMap : EntityTypeConfiguration<Cari>
    {
        public CariMap()
        {
            ...
            this.Property(p => p.Fax).HasMaxLength(15);
            this.Property(p => p.Email).HasMaxLength(50);
            this.Property(p => p.WebAdresi).HasMaxLength(50);
            this.Property(p => p.Il).HasMaxLength(25);
            this.Property(p => p.Ilce).HasMaxLength(25);
            ...
            this.Property(p => p.VergiNo).HasMaxLength(30);
            this.Property(p => p.IskontoOrani).HasPrecision(5,2);
            this.Property(p => p.RiskLimit).HasPrecision(8,2);
            ...
            this.Property(p => p.WebAdresi).HasColumnName("WebAdresi");
